...
// Generic exam logo
const genericLogo =
  "https://img.icons8.com/color/48/000000/test-passed.png";
...
const staticExams = Array.from(
  new Set(Object.values(stateExams).flat())
);
            ...
            return (
              <Link
                ...
                className={`bg-white shadow-lg rounded-xl p-4 flex flex-col items-center hover:shadow-2xl transition-shadow duration-300 cursor-pointer border-t-4 ${
                  isLive ? "border-green-500" : "border-blue-100"
                }`}
              >
